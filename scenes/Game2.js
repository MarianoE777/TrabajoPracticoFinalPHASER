export default class Game2 extends Phaser.Scene {
  ...
  // fondo grande
    ...
    // texto
    this.scoreText = this.add.text(16, 16, "Personas Encerradas: 0 de 4", {
      fontSize: "24px",
      fill: "#ffffff"
    });
    ...
    this.timerText = this.add.text(500, 16, "Tiempo: 30", {
      fontSize: "28px",
      fill: "#ffffff"
    }).setScrollFactor(0);
  ...
  reachGoal(jugador, casa) {
    if (this.tienePersona) {
      ...
      this.scoreText.setText("Personas Encerradas: " + this.score + " de 4");
      if (this.score >= 4) {
        this.ganar();
      }
    }
